...
const subtitleIcons = subtitleButton.querySelectorAll('use');
const pipButton = document.getElementById('pip-button')

console.log("test js refersh");
...
function updateFullscreenButton() {
  ...
  console.log("I'm full screen button click");
...
subtitleButton.addEventListener('click', updateSubtitleButton);
